...
namespace UV7_Edit.Preferences
{
    ...
    [AttributeUsage(AttributeTargets.Class)]
    public class ParentCategoryAttribute : CategoryAttribute
    {
        public ParentCategoryAttribute() : base() { }
        public ParentCategoryAttribute(string category) : base(category) { }
    }

    [AttributeUsage(AttributeTargets.Class)]
    public class LocalizedParentCategoryAttribute : ParentCategoryAttribute
    {
        public string ResourceKey { get; }
        public LocalizedParentCategoryAttribute(string resourceKey)
        {
            ResourceKey = resourceKey;
        }
