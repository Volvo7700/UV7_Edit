...
// Namespace as of AlexxEG's version: UnFound
...
namespace UV7_Edit.Tools
{
    ...
    internal class NativeToolStripRenderer : ToolStripSystemRenderer
    {
        ...
        private bool EnsureRenderer()
        {
            ...
            if (renderer == null)
                renderer = new VisualStyleRenderer("Rebar", 0, 0);
        ...
        public bool OnRenderToolStripStyledPanelBackground(PaintEventArgs e)
        {
            if (EnsureRenderer())
            {
                if (VisualStyleRenderer.IsElementDefined(VisualStyleElement.CreateElement(RebarClass, RebarBackground, 0)))
